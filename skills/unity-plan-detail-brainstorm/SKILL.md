---
name: unity-plan-detail-brainstorm
...
- **Technical Deep-Dive**: Use `unity-code-investigator` to trace exact line numbers, method signatures, and class relationships for the task.
...
2.  **Codebase Investigation**:
    - **Load Skill**: `unity-code-investigator`.
